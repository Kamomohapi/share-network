        ...
        <section className="content-section text-white text-center" id="services">
          <div className="container">
            <div className="content-section-heading">
              ...
              <h1 className="mb-5" style={{ color: "white" }}>Creator and Founder of FoodShare Network ...</h1>
            </div>
            <div className="row">
              ...
              <div className="col-lg-2 col-md-6 mb-5 mb-lg-0">
                <span className="service-icon rounded-circle mx-auto mb-3">
                  <a href="https://lloydmarcelino.com" target="blank_"> <img src={Icon} style={{ width: "150px", height: "150px" }} alt="Lloyd Marcelino" id="contact_photo"></img></a>
                </span>
                <h4>
                  <strong>Kgomotso Moeti</strong>
                </h4>
                <p className="text-faded mb-0" style={{ color: "white" }}>Software Developer</p>
                <p className="text-faded mb-0" style={{ color: "white" }}>Tshwane University of Technology</p>
              </div>
              <div className="col-lg-2 col-md-6 mb-5 mb-md-0">
                <span className="service-icon rounded-circle mx-auto mb-3">
                  <a href="https://ohhhhhwhen.github.io/React-Portfolio" target="blank_"><img src={Icon} style={{ width: "150px", height: "150px" }} alt="Owen Chantala" id="contact_photo"></img></a>
                </span>
                <h4>
                  <strong>Vumani Dlamini</strong>
                </h4>
                <p className="text-faded mb-0" style={{ color: "white" }}>Software Developer</p>
                <p className="text-faded mb-0" style={{ color: "white" }}>Tshwane University of Technology</p>
              </div>
              <div className="col-lg-2 col-md-6 mb-5 mb-md-0">
                <span className="service-icon rounded-circle mx-auto mb-3">
                  <a href="https://ben-react-portfolio-v2.herokuapp.com/" target="blank_"><img src={Icon} style={{ width: "150px", height: "150px" }} alt="Ben Olsen" id="contact_photo"></img></a>
                </span>
                <h4>
                  <strong>Kamohelo Mohapi</strong>
                </h4>
                <p className="text-faded mb-0" style={{ color: "white" }}>Software Developer</p>
                <p className="text-faded mb-0" style={{ color: "white" }}>Tshwane University of Technology</p>
              </div>
              <div className="col-lg-2 col-md-6 mb-5 mb-md-0">
                <span className="service-icon rounded-circle mx-auto mb-3">
                  <a href="http://serene-headland-14339.herokuapp.com/" target="blank_"><img src={Icon} style={{ width: "150px", height: "150px" }} alt="Ari Horowitz" id="contact_photo"></img></a>
                </span>
                <h4>
                  <strong>Ndumiso Buthelezi</strong>
                </h4>
                <p className="text-faded mb-0" style={{ color: "white" }}>Software Developer</p>
                <p className="text-faded mb-0" style={{ color: "white" }}>Tshwane University of Technology</p>
              </div>
              ...
              <div className="col-lg-2 col-md-6">
                <span className="service-icon rounded-circle mx-auto mb-3">
                  <a href="https://github.com/jaredKong" target="blank_"><img src={Icon} style={{ width: "150px", height: "150px" }} alt="Jared Kong" id="contact_photo"></img></a>
                </span>
                <h4>
                  <strong>Tebogo Mashitatona</strong>
                </h4>
                <p className="text-faded mb-0" style={{ color: "white" }}>Software Developer (Frontend)</p>
                <p className="text-faded mb-0" style={{ color: "white" }}>Harvard University</p>
              </div>
            </div>
              ...
              render={({ handleChange, handleBlur, values, errors, handleSubmit, touched }) => (
                <Fragment>
                  ...
                  <Form className="site-form" onSubmit={handleSubmit}>
                    ...
                    <Button className="site-form__action" type="submit" id="btn btn-secondary btn-md btn-radius" disabled={isSending}>
                      {
