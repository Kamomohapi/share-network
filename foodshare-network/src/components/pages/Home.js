...
import RedHand from '../images/redhand.jpg';
import HeartHand from '../images/hearthand.jpg';
    ...
    <div>
      ...
      <div className="normal" data-aos="fade-down" data-aos-delay="100" style={{ backgroundColor: "#FFFFFF", paddingTop: "100px", paddingBottom: "100px" }}>
        <div className="page_inner_div">
          <h1 style={{ fontWeight: "900", color: "#263238", marginTop: "30px" }} id="responsive_h1" data-aos="zoom-in" data-aos-delay="100">FoodShare Network</h1>
          ...
          <Button variant="outline-secondary" href="#">GoFundme</Button>{' '}
        ...
        <div className="page_inner_div">
          ...
          <div className="row" style={{ paddingTop: "50px" }}>
            ...
            <div className="col-md-6" data-aos="zoom-in" data-aos-delay="100" style={{ padding: "0 90px 0 90px" }}>
              ...
              <p id="responsive_h7" style={{ color: "white" }} className="responsive_h7">We believe the ability of people to strive for better lives, and we help provide them wth the means to achieve their dreams.</p>
            </div>
            <div className="col-md-6" data-aos="zoom-in" data-aos-delay="100" style={{ padding: "0 90px 0 90px" }}>
      ...
      <div className="normal" style={{ backgroundColor: "#FFFFFF", paddingTop: "100px", paddingBottom: "100px" }}>
        ...
        <p id="responsive_h7" style={{ color: "#66615b", padding: "10px 90px 30px 90px" }} data-aos="right" data-aos-delay="100">
          Members of FoodShare Network will receive numerous perks on their
          ...
          Give back by making FoodShare Network.com a mainstay in your giving
            mission.</p>
        <div className="page_inner_div">
